...
/**
 * Created by chad1231 on 2017-04-21.
 */
public class HybridPresenceSensorAgent extends AgentComponent{
    private static final Logger LOGGER = LoggerFactory.getLogger(HybridPresenceSensorAgent.class);
    ...
    @ContextField(publishAsUpdated = true) public Context inferredUserPresence;

    public HybridPresenceSensorAgent(EventDispatcher eventDispatcher, Agent agent) {
    ...
    public void run() {
        ...
        inferredUserPresence.updateValue("empty");
